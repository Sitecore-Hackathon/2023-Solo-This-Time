...
Add-HostsEntry "cm.solothistime.localhost"
if ($Topology -ne "xp0") {
  Add-HostsEntry "cd.solothistime.localhost"
}
Add-HostsEntry "id.solothistime.localhost"
Add-HostsEntry "www.solothistime.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.solothistime.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.solothistime.localhost"
    }

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.solothistime.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.solothistime.localhost"

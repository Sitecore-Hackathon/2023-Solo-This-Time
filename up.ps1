...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.solothistime.localhost/ --auth https://id.solothistime.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
  dotnet sitecore login --cm https://cm.solothistime.localhost/ --auth https://id.solothistime.localhost/ --allow-write true
}
...
Start-Process https://cm.solothistime.localhost/sitecore/
Start-Process https://www.solothistime.localhost/

...
Function Add-JssProject {
  ...
  try {
    ...
    $jssCreateParams = "--templates nextjs,nextjs-sxa"
    ...
    try {
      jss setup `
        ...
        --layoutServiceHost "https://cm.solothistime.localhost" `
        --apiKey "538CCF2A-BFE5-4B50-9263-1053C0B8E577" `
        --deployUrl "https://cm.solothistime.localhost/sitecore/api/jss/import" `
        --deploySecret "1EF7423412D5450CBC44E8652D345E65" `
        --nonInteractive `
